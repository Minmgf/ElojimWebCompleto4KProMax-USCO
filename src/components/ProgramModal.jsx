...
export default function ProgramModal({ program, onClose, isOpen }) {
  ...
  const getFieldType = (campo) => {
    ...
    if (Array.isArray(campo.opciones) && campo.opciones.length === 0) {
      // Si el tipo original es textarea, usar textarea
      if (campo.tipo === "textarea") return "textarea";
      // Si el tipo original es number, usar number
      if (campo.tipo === "number") return "number";
      // Si el tipo original es email, usar email
      if (campo.tipo === "email") return "email";
      // Si el tipo original es date, usar date
  ...
  const renderField = (campo) => {
    ...
    const commonClasses =
      "border rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white";
        ...
        return (
          <div key={campo.nombre} className="flex flex-col mb-6">
            ...
            <input
              ...
              onChange={(e) =>
                handleSpecificInfoChange(campo.nombre, e.target.value)
              }
          ...
          <div key={campo.nombre} className="flex flex-col mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {campo.opciones.map((op) => (
                <label
                  key={op}
                  className="flex items-center gap-3 cursor-pointer p-3 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200"
                >
                  <input
                    type="radio"
                    name={campo.nombre}
          ...
          <div key={campo.nombre} className="flex flex-col mb-6">
            ...
            >
              ...
              {campo.opciones.map((op, idx) => (
                <option key={idx} value={op} className="py-2">
                  {op}
                </option>
              ))}
            </select>
              ...
              {campo.opciones.map((op) => (
                ...
                >
                  <input
                    type="checkbox"
                    checked={
                      formData.specificInformation[campo.nombre]?.includes(
                        op
                      ) || false
                    }
                    onChange={(e) => {
                      const currentValues =
                        formData.specificInformation[campo.nombre] || [];
                      if (e.target.checked) {
                        handleSpecificInfoChange(campo.nombre, [
                          ...currentValues,
                          op,
                        ]);
                      } else {
            ...
            <div className="p-6 md:p-8">
              {loading && !programDetails ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("comune", e.target.value)
                          }
                          className="border rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("socialStratum", e.target.value)
                          }
                          className="border rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("etnicalGroup", e.target.value)
                          }
                          className="border rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                        >
                  ...
                  {programDetails?.specificInformation?.secciones?.map(
                    (sec, i) => (
                      <div
                        key={i}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="text-gray-700">
                        ...
                        <p className="text-sm leading-relaxed">
                          ...
                          del programa y autorizo el tratamiento de mis datos
